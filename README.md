# SkillForge
# 💡 SkillForge – Adaptive Hackathon AI Teammate
### Team: Tech Riders  
...
🔗 **[Live SkillForge Prototype](https://project-eta-mauve.vercel.app/)**  
...
## 💻 GitHub Repository
📂 **[Source Code Repository](https://github.com/devaprasathk28-dot/SkillForge)**  
Contains:
- All frontend & backend source files  
- `/api/` folder with serverless functions  
- `README.md` (this document)  
- `/docs/` folder with workflow diagram & presentation slides  
- `prototype_link.txt` and `demo_link.txt`
...
3. Walkthrough of live prototype on Vercel  
4. Key features and functionality demo  
5. Closing impact statement

---

## 📊 Workflow Diagram (AutoFlow Engine)
